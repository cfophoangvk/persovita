    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg overflow-hidden">
        <div className="flex p-6 items-center gap-6">
          <div className="w-28 h-28 rounded-full bg-amber-400 flex items-center justify-center text-white text-3xl font-bold">
            {initials}
          </div>
          <div className="flex-1">
            ...
            <div className="mt-4 flex gap-3">
              <button
                ...
                className="px-4 py-2 bg-amber-500 text-white rounded-full font-semibold"
              >
