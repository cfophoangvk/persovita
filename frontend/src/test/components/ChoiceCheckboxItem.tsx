...
const ChoiceCheckboxItem = (props: ChoiceCheckboxItemProps) => {
  return <button className={`flex text-lg px-3 py-6 items-center gap-3 w-[300px] border rounded-md transition-colors hover:border-black hover:border-2 duration-300 ${props.checked ? "border-black border-2" : "border-gray-300"}`} onClick={props.onClick}>
    <div>
